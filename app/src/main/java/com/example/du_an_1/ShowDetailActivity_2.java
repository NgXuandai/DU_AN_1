...
public class ShowDetailActivity_2 extends AppCompatActivity {
    ...
    Splashscreenactivity.chitietDonHang chitietDonHang;
    String fd, a;
        ...
        btnAddToCart.setOnClickListener(view -> {
            ...
            Cursor cursor = dao_gioHang.getCart(userID);
                ...
                cursor.moveToFirst();
                    ...
                    food_dao = new Food_DAO(this);
                    dao_chitietDonHang = new DAO_chitietDonHang(this);
                    Splashscreenactivity.chitietDonHang orderDetail = dao_chitietDonHang.getExistOrderDetail(cursor.getInt(0));
//           if ((orderDetail == null)){
                    Log.i("SQLite", "tren");
                    dao_chitietDonHang = new DAO_chitietDonHang(this);
                    food_dao = new Food_DAO(this);
                    boolean addOrderDetail = dao_chitietDonHang.addOrderDetail(new Splashscreenactivity.chitietDonHang(cursor.getInt(0),
